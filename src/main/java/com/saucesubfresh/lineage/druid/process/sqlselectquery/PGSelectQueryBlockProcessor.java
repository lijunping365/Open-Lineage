...
/**
 * PGSelectQueryBlock use case: create view view_test as select temp.a1,temp.a2 ( select a1,a2 from
 * table1 ) temp
 *
...
public class PGSelectQueryBlockProcessor extends AbstractSQLSelectQueryProcessor {
  ...
  public void process(
    ...
    List<ColumnNode> columnList =
        pgSelectQueryBlock.getSelectList().stream()
    ...
    // 继续向下处理
    ProcessorRegister.getTableSourceProcessor(pgSelectQueryBlock.getFrom().getClass())
